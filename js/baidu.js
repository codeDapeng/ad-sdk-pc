    ...
    ! function () {
        ...
        ! function () {
            var i = {
                ...
                $oojs: function () {
                    var i = {};
                    if ("undefined" != typeof window && window && "undefined" != typeof document && document ? (this.runtime = "browser", i.global = window) : (this.runtime = "node", i.global = t), i.proxyName = "proxy", i.path = "node" === this.runtime ? process.cwd() + "/src/" : "/src/", "undefined" != typeof e)
        ...
        i.setPath("https://dup.baidustatic.com/"), i.define({
            ...
            $config: function () {
                this.HTTP_PROTOCOL = "https:" === document.location.protocol ? "https:" : "http:", 0 !== location.protocol.indexOf("http") && (this.HTTP_PROTOCOL = "https:"), i.global.userConfig && i.global.userConfig.domain && (this.REQUEST_URL_CNAME = i.global.userConfig.domain || "")
            }
        }), i.define({
            name: "lang",
                    ...
                    if (1 === e.version) n = n.replace(o, "");
                        ...
                        for (var d = ["default", "hover"], l = 0; l < d.length; l++) {
                            var c = d[l],
                                ...
                                u = c + "Italic",
                                m = c + "Underline";
                            e[h] = "#" + e[h], e[p] = e[p] ? "bold" : "normal", e[u] = e[u] ? "italic" : "normal", e[m] = e[m] ? "underline" : "none"
                        }
                    }
            ...
            processExtendsParam: function (t) {
                ...
                if (5 !== i.sizeType && 0 !== t.id.indexOf("u")) {
                    ...
                    if (0 === u) {
                        ...
                        m.style.width = h + "px", m.style.height = p + "px", m.style.display = "inline-block"
                    }
                }
            },
            ...
            getPmpRequestUrl: function (t) {
                ...
                if (c) {
                    ...
                    var p = t.width,
                        u = t.height;
                    p > 0 && u > 0 && (i.sz && (i.sz = ""), n.push("sz=" + p + "x" + u)), (t.pcwd || 5 === h.sizeType) && n.push("conwid=" + p), (t.pchd || 5 === h.sizeType) && n.push("conhei=" + u);
                    var m = c.pdb_deliv;
                    ...
                    0 === t.id.indexOf("u") ? n.push("dc=3") : n.push("dc=2"), s && a > 0 && (i.tt = a + "." + (d - a) + "." + (l - a) + "." + (+new Date - a)), i.exps && (n.push("exps=" + i.exps), i.exps = "")
                }
                var w = n.join("&");
            ...
            createSlot: function (t) {
                ...
                var i = {};
                return i.index = this.slotIdCountMap[e]++, i.count = ++this.slotCount, i.id = e + "_" + i.index, i.containerId = this.config.DUP_PREFIX + "_wrapper_" + e + "_" + i.index, i.slotId = t.slotId, i.productLine = t.productLine, i.errors = [], i.isAsync = t.isAsync, this.setStatus(i.id, this.config.STATUS_CREATE), n ? i.timestampWatcher = {
                    t1: n
                } : i.timestampWatcher = {
                    t1: 0
                }, window.cproStyleApi ? i.styleOpenApi = window.cproStyleApi[e] || {} : i.styleOpenApi = {}, 0 === e.indexOf("u") && (i.productLine = "union",
                    i.width = i.styleOpenApi.cpro_w || i.styleOpenApi.rsi0 || 0, i.height = i.styleOpenApi.cpro_h || i.styleOpenApi.rsi1 || 0), i
            },
            ...
            processSlot: function (t) {
                if (t.isPdbAd = !1, t.isNeedCacheRequest = !1, t.response) {
                    ...
                    t.isPdbAd = !(n || o || r || s), t.isNeedCacheRequest = 0 !== n || 0 !== r
                }
            },
            addSlot: function (t) {
            ...
            requestSlotInfo: function (t) {
                ...
                var e = !1;
                t.paramObj = this.param.getParamObj(t), t.paramObj.exps = t.exps || this.config.EXP_ID, t.paramObj.pcn = this.config.IS_CNAME ? this.config.REQUEST_URL_CNAME : "";
                var n, o;
                t.posUrl && (this.browser.antBrowser || t.proxy) ? (t.paramObj.ctxant = "1", t.paramObj.pcn = t.pcn, n = this.param.getParamString(t.paramObj), o = t.posUrl + n) : (n = this.param.getParamString(t.paramObj), o = this.config.POS_URL + n), t.paramObj.dtm = this.config.HTML_POST, t.timestampWatcher.t2 = +new Date;
                var r = !1;
            ...
            processFrameData: function (t) {
                ...
                if (c) e = c;
                    ...
                    this.data.defineOnce(u, i.proxy(this, this.cacheRequestCallback)), this.data.defineOnce(p, i.proxy(this.requestCache, this.requestCache.cacheRequest)), e = this.param.getPmpRequestUrl(t), o = 'onload="' + p + "('" + t.paramObj.dpv + "', this);\""
            ...
            render: function (t, e) {
                ...
                for (var c = d.childNodes, h = [], p = 0; c[p]; p++) !this.isNeededNode(c[p], "script") || c[p].type && "text/javascript" !== c[p].type.toLowerCase() || h.push(c[p]);
                h.reverse();
                for (var u = 0, m = h.length; m > u; u++) this.evalScript(h[u].parentNode.removeChild(h[u]), d);
                return !0
            }
        }), i.define({
            name: "floatBlock",
            ...
            processSlotInfo: function (t) {
                ...
                if (1 === o) e.width = r, e.height = s;
                    ...
                    var p = this.param.translateScaleToPixelSize(e.wScale, e.hScale, l);
                    n.width = p.width, n.height = p.height, t.width = p.width, t.height = p.height, e.width = p.width, e.height = p.height
                } else if (3 === o) {
                    var u = this.getCurViewportWidth(r);
                    n.width = t.width = e.width = u, n.height = t.height = e.height = s
                }
                e.sizeType = o;
